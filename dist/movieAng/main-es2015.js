...
let ActorComponent = class ActorComponent {
    //In this constructor, angular will create an instance fo you
    ...
    //Delete before Year
    onDeleteYear(aYear) {
        this.dbService.deleteMovieYear(aYear).subscribe(result => {
            this.onGetMovies();
        });
    }
    // Add Actor to Movie
...
let DatabaseService = class DatabaseService {
    ...
    deleteMovieYear(aYear) {
        let url = "movies/deleteYear/" + aYear;
        return this.http.delete(url, httpOptions);
    }
    addActor(mid, aid) {
...
module.exports = __webpack_require__(/*! C:\Users\Chev\Google Drive\UNI 2019 S2\FIT2095\Week 10\Lab\movieAng\src\main.ts */"./src/main.ts");
